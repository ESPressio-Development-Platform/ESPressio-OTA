...
int main() {
...
#elif ESPRESSIO_OTA_PLATFORM_RECOVERY_SCENARIO == 4
    ...
    // This regression has its own process because OTA State runtime setup is
    // intentionally single-runtime for a native test process.
    {
        Fixture fixture;
